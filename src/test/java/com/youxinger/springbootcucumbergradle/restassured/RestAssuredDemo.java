package com.youxinger.springbootcucumbergradle.restassured;
...
public class RestAssuredDemo {
    ...
    public void testJsonResponse() {
        ...
        List<SystemUser> gameList = JSONObject.parseArray(response.body().asString(), SystemUser.class);
    ...
    public void testConditions() {
        get("http://localhost:8080/getJsonObject/38")
                ...
                .time(lessThan(2000L)); // Milliseconds, 验证返回时间
    }
    ...
    public void testLanChao() {
        Response loginResponse= given()
                ...
                .formParam("password","123456ba")
                .request()
                .header("Accept","application/json, text/plain, */*")
                .post("http://pre.lchapp_api.youxinger.net/frontStage/login/login");
